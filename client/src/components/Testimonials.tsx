    ...
    <section className="py-24 bg-zinc-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">Não acredite apenas em nossa palavra. Veja o que nossos usuários têm a dizer sobre sua experiência com a Calculadora Imobiliária.</p>
        </div>
